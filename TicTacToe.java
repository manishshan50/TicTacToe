...
public class TicTacToe {
    ...
    public static String checkWinner(){
        ...
        for (List l : winning ) {
            if (playerPosition.containsAll(l)){return "Congratulation you Win";}
            else if (playerPosition.containsAll(l)){return "CPU wins!Sorry :(";}
            else if (playerPosition.size() + cpuPosition.size() == 9){return "CAT";}
        }
        return " ";
    }
}